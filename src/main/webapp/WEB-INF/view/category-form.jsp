            ...
            <div class="card card-primary">
              ...
              <form:form role="form" action="category-save" modelAttribute="category">
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Enter image URL" 
	                        ...
	                        <form:checkbox
	                     	 ...
	                     	 <c:choose>
		                       	 <c:when test="${isAdmin}">     <!-- Samo admin: -->       
		                       	 		 <c:choose>                	          
                       	              	 	 <c:when test="${category.priority !=-1}">  <!-- Uncategorized : -->  
		              							  	<div class="form-group">
							                    	<label>Priority</label>
							                    	<form:input type="text" class="form-control" placeholder="Enter priority" 
							                    		path="priority" /> 
							                        </div>   
							                 </c:when>
							              </c:choose>
                ...
                <div class="card-footer">
                  ...
                  <a href="/BlogProject/admin/category-list" class="btn btn-outline-secondary">Cancel</a>
                </div>
              </form:form>
