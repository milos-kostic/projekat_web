          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Post Tags Form</h3>
              </div>
              <!-- /.card-header -->
              ...
              <form:form role="form" action="tag-save" modelAttribute="tag">
	                ...
	                <div class="card-body">
	                  ...
	                  <div class="input-group my-colorpicker2 colorpicker-element" data-colorpicker-id="2">
		                    ...
		                    <form:input type="text" class="form-control" data-original-title="" title="color"
		                    		path="color" />
		                    
		                    <div class="input-group-append">
		                      <span class="input-group-text">
		                      		<i class="fas fa-square" style="color: ${tag.color}"></i>
		                      </span>
		                    </div>
	                ...
	                <div class="card-footer">
	                  ...
	                  <a href="tag-list.html" class="btn btn-outline-secondary">Cancel</a>
	                </div>
